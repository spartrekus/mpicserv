...
/// MPIC TELNET VIEWER
//////////////////
// usage : clang mpicsrv.c -o mpicsrv 



//////////////////
/// NETBSD ROCKS AND WORKS ON PI !!! 
//////////////////
  ...
  while(1) {
    ...
    for (readsock = listenfd +1; readsock < MAX_FD ; readsock++) {
      ...
      if (!writecnt) {
           ...
           if      ( strcmp( chat , "ls" ) == 0 )    nls();
           else if ( strcmp( chat , "clr" ) == 0 )   nsystem( " pkill mupdf " ); 
           else
           {
              nrunwith( " screen -d -m  mupdf ", chat );
           }
      }
